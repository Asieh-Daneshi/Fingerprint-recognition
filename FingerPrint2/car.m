...
hVidReader = vision.VideoFileReader(filename,'PlayCount',1, 'ImageColorSpace', 'RGB','VideoOutputDataType', 'single');

%--------------------------------------------------------------------------
% Optical flow object for estimating direction and speed of object motion
hOpticalFlow = vision.OpticalFlow('OutputValue', 'Horizontal and vertical components in complex form','ReferenceFrameDelay', 1);
